...
(awk '{print "JOB " $0}' < gadsby.txt | nc nuthatch.cs.umanitoba.ca $1) &
(awk '{print "JOB " $0}' < pride.txt  | nc nuthatch.cs.umanitoba.ca $1) &
(awk '{print "JOB " $0}' < wap.txt  | nc nuthatch.cs.umanitoba.ca $1) &
